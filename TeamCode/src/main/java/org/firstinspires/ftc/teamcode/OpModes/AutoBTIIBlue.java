...
@Autonomous(name="BTII Blue Auto", group="OpMode")
public class AutoBTIIBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        BTIIBlueDetector detector = new BTIIBlueDetector();
        ...
        BTIIBlueDetector.Location en = detector.getLocation();
        if (en == BTIIBlueDetector.Location.LEFT){
            pos = 1;
        } else if (en == BTIIBlueDetector.Location.RIGHT){
            pos = 0;
        }
