...
public class Detector extends OpenCvPipeline {
    ...
    private static final Rect LEFT_ROI = new Rect(new Point(0, 35), new Point(70, 100)); // 0 35 , 70 100
    private static final Rect RIGHT_ROI = new Rect(new Point(80, 35), new Point(150, 100)); // 80 35 , 150 100
    private static final Rect MID_ROI = new Rect(new Point(160, 35), new Point(230, 100)); // 160 35 , 230 100
